...
COMPILER_RT_DEPENDENCIES = host-clang
...
define COMPILER_RT_SETUP_RUNTIME_LIBS
	...
	ln -sf --no-target-directory ../../../../$(GNU_TARGET_NAME)/sysroot/usr/lib/linux $(HOST_DIR)/lib/clang/$(HOST_CLANG_VERSION)/lib/linux
	ln -sf --no-target-directory ../../../$(GNU_TARGET_NAME)/sysroot/usr/share $(HOST_DIR)/lib/clang/$(HOST_CLANG_VERSION)/share
endef
